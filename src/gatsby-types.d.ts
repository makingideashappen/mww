...
type Query_sanityPostArgs = {
  ...
  readMore: InputMaybe<StringQueryOperatorInput>;
...
type SanityPost = Node & SanityDocument & {
  ...
  readonly readMore: Maybe<Scalars['String']>;
...
type SanityPost__rawContentArgs = {
  resolveReferences: InputMaybe<SanityResolveReferencesConfiguration>;
};
...
type SanityPostFieldSelector = {
  ...
  readonly readMore: InputMaybe<FieldSelectorEnum>;
...
type SanityPostFilterInput = {
  ...
  readonly readMore: InputMaybe<StringQueryOperatorInput>;
...
type SanityPostSortInput = {
  ...
  readonly readMore: InputMaybe<SortOrderEnum>;
...
type IndexPageQuery = { readonly allSanityPost: { readonly nodes: ReadonlyArray<{ readonly title: string | null, readonly readMore: string | null, readonly description: string | null, readonly publishedAt: string | null, readonly slug: { readonly current: string | null } | null }> }, readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null } | null } | null };

type SinglePostQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type SinglePostQuery = { readonly sanityPost: { readonly title: string | null, readonly readMore: string | null, readonly description: string | null, readonly publishedAt: string | null, readonly _rawContent: Record<string, unknown> | null, readonly slug: { readonly current: string | null } | null } | null, readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null } | null } | null };
